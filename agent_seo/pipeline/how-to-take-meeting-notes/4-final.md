...
| Purpose | Track decisions and next steps | Legal or official record |
...
What you can skip: verbatim dialogue, pleasantries, tangents, everything said before someone actually made a point. According to [Notta's 2024 data](https://www.notta.ai/en/blog/meeting-statistics), 70% of meeting decisions are forgotten within 24 hours without documented notes. The solution isn't more notes. It's sharper notes.
...
4. **Write in shorthand for descriptions, full sentences for decisions.** "New pricing model discussed, pro/con list shared" is fine as shorthand. "We will not increase pricing this quarter" needs to be written in full.
...
9. **Send to all attendees by end of day.** Notes that sit unsent lose half their value. A quick email with the notes as plain text (or linked doc) closes the loop.
10. **Move action items into your task system.** Notes are not a task manager. Transfer every action item to whatever your team uses (Jira, Asana, Notion, a spreadsheet). The notes then become the historical record.
...
| Mind map | Brainstorming and creative reviews | Hard to extract action items |
...
1. [Meeting Statistics 2025](https://myhours.com/articles/meeting-statistics-2025) by My Hours (2025)
2. [45 Meeting Statistics and Behavior Trends](https://fellow.ai/blog/meeting-statistics-the-future-of-meetings-report/) by Fellow AI (2025)
3. [Meeting Statistics 2026](https://www.cirrusinsight.com/blog/meeting-statistics) by Cirrus Insight (2026)
4. [Meeting Notes Tips: How to Take Notes](https://asana.com/resources/meeting-notes-tips) by Asana (2025)
5. [Meeting Notes Statistics](https://www.notta.ai/en/blog/meeting-statistics) by Notta (2024)
6. [How to Take Effective Meeting Notes](https://slack.com/blog/productivity/how-to-take-effective-meeting-notes) by Slack (2025)
7. [State of Meetings Report 2024](https://fellow.ai/resources/state-of-meetings-2024) by Fellow (2024)
...
```json
{
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Five things: the date and list of attendees, the topics covered (the agenda), decisions made (written clearly, not interpreted), action items with named owners and due dates, and open questions for follow-up."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Stop trying to transcribe and start listening for decision moments, action items, and key points. Write in shorthand for descriptions and full sentences for decisions. If unsure what was decided, ask before moving on."
      }
    },
    {
      "@type": "Question",
